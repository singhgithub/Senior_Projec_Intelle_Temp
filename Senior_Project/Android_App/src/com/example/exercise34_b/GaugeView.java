...
public class GaugeView extends View {
    ...
    public GaugeView(final Context context, final AttributeSet attrs, final int defStyle) {
    	...
    	System.out.println("[GaugeView Class] constructor1() is Called");
    ...
    public GaugeView(final Context context, final AttributeSet attrs) {
        ...
        System.out.println("[GaugeView Class] constructor2() is Called");
        System.out.println(".........................");
    }

    public GaugeView(final Context context) {
        this(context, null, 0);
        System.out.println("[GaugeView Class] constructor3() is Called");
    }

    private void readAttrs(final Context context, final AttributeSet attrs, final int defStyle) {
    	System.out.println("[GaugeView Class] readAttrs() is Called");
        ...
        //this was giving me a error(GaugeView_showText cannot be resolved or is not a field) so i comment it out for nw
    ...
    private void readRanges(final Resources res, final int rangesId, final int colorsId) {
    	System.out.println("[GaugeView Class] readRanges() is Called");
    ...
    private void init() {
        ...
        // calls.
    	System.out.println("[GaugeView Class] init() is Called");
    ...
    public void initDrawingRects() {
    	System.out.println("[GaugeView Class] initDrawingRects() is Called");
    ...
    private void initDrawingTools() {
    	System.out.println("[GaugeView Class] initDrawingTools() is Called");
    ...
    private void drawGauge() {
    	System.out.println("[GaugeView Class] drawGauge() is Called");
