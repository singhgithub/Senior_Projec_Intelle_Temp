...
public class Post_Servlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//i could but the below to line in a syncrous block or a sync method using a dumy object for locking
		//so that if i get an error at serial stuff then the servlet don't write respose
