...
/**
 * Servlet implementation class Room2_Servlet
 */
@WebServlet("/Room2_Servlet")
public class Room2_Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Room2_Servlet() {
        super();
        System.out.println("[Room2_Servlet Class] Constructor is Called");    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		double[] response_data_array = Database.bd.pull_Data_For_Room2_Graph();
