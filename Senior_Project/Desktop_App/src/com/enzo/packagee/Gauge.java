...
public class Gauge extends Control {
    ...
    private DoubleProperty                       value;							//this is the temp value that being displayed in the gauge 
    ...
    // ******************** Constructors **************************************
    /*don't need this after i though about it 
     * public Gauge(){
    	System.out.println("[Gauge Class] First Constructor() is Called");
    }*/
    
    
    public Gauge() {
    	
    	System.out.println("[Gauge Class] Constructor() is Called");
    	//System.out.println("[DemoGauge Class   ]");
    	//System.out.println("[GaugeBuilder Class]");
    	//System.out.println("[GaugeSkin Class   ]");
    	...
    	//????? it seems like not adding a gauage.css class but adding one of it element 
        //if i comment below out then everything completely changes, every thing disapper and it goes to like a default simple look
    	//		like the threshod, suee, 
    	
    	//This been commented due to the problem that i faced in the Exercise29-b where i have to call the getValue() method of the
    	// * 	Guage class and i can't create an object of the Guage class in the serial class becuase the construtor has whole lot of shit in it
    	 //* 	So all i have to do is every time i declare&intialize the class rite after a function need to be called where all the stuff below gonna go
    	 //* 
    	
    	getStyleClass().add("gauge");
        System.out.println("[Gauge Class] Constructor(): getStyleClass() is add to the screen");
    	
    	//this is the temp value that is displayed in the gauge 
    ...
    /*Don't have to do below i can have multiple constructors
     * //speical method needed for the Exercise29-b, intializing the Guage class in the Serial_Example class
    //"DONT FORGET" - always call this method rite after you delcare&intialize the Gauge Class 
    public void gauge_Class_Needed_Constructor(){
    	getStyleClass().add("gauge");
        System.out.println("[Gauge Class] Constructor(): getStyleClass() is add to the screen");
    ...
    public final double getValue() {
    	System.out.println("[Gauge Class] getValue() is Called");
        
    	return value.get();
    }
   
    public final void setValue(final double VALUE) {
    	System.out.println("[Gauge Class] setValue() is Called");
    ...
    /*//this is the satic version of the method above, for the serialExample class 
    //this is one way of doing this, not sure how making all these static will effect the rest of the code, for now find another way 
    public final static void setValue_Static(final double VALUE) {
    	System.out.println("[Gauge Class] setValue() is Called");
    ...
    public final double getThreshold() {
    	System.out.println("[Gauge Class] getThreshold() is Called");			//i think it was called so many time so its been commented
        return null == threshold ? _threshold : threshold.get();
    
    }
    public final void setThreshold(final double THRESHOLD) {
    	System.out.println("[Gauge Class] setThreshold() is Called");
    ...
    @Override protected Skin createDefaultSkin() {
    	System.out.println("[Gauge Class] createDefaultSkin() is Called");
        return new GaugeSkin(this);
    }

    @Override protected String getUserAgentStylesheet() {
    	//i don't kw how to point to the resources folder so i just put it in the package 
    	
    	//System.out.println(getClass().getResource("gauge.css").toExternalForm());
    	
    	System.out.println("[Gauge Class] getUserAgentStylesheet() gauge.css is being loaded");
